# Generated by Django 2.1.8 on 2019-06-05 00:05
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('expertID', models.CharField(max_length=255, null=True, verbose_name='专家在ES中的id')),
        ...
        migrations.CreateModel(
            name='Fields',
            fields=[
                ('id', models.AutoField(primary_key=True, serialize=False, verbose_name='领域编号')),
        ...
        migrations.CreateModel(
            name='Tags',
            fields=[
                ('id', models.AutoField(primary_key=True, serialize=False, verbose_name='用户领域ID')),
                ('fieldID', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='users.Fields', verbose_name='用户领域')),
            ],
            options={
                'verbose_name': '用户领域表单',
                'verbose_name_plural': '用户领域表单',
            },
        ),
        migrations.CreateModel(
            name='ExpertProfile',
            fields=[
                ...
                ('realName', models.CharField(max_length=255, verbose_name='真实姓名')),
                ('expertID', models.CharField(default='9000000000000', max_length=255, verbose_name='专家在ES中的id')),
